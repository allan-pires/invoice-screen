...
public class LineItemTest extends TestCase{
    ...
    public void testConstructor_returnsNewObject_whenCalled(){
        ...
        Assert.assertEquals(new Date(2016, 11, 12), item.getPostDate());
    ...
    public void testSetPostDate_setsPostDate_whenCalled(){
        Date postDate = new Date(2016,11,12);
    ...
    public void testGetPostDateDayMonth_returnsString_whenCalled(){
        LineItem item = LineItemFactory.createLineItemObject();
        Assert.assertEquals("12 Dec", item.getPostDateDayMonth());
    }
